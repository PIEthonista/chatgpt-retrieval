...
# to look into
#  - change prompt from hub.pull() to custom
#  - how to inject user data? below function call?
#  - openai function call https://medium.com/gitconnected/understanding-openai-function-calling-a6bc58ecf849  https://platform.openai.com/docs/guides/function-calling


# since hard prompt has to be initialized with model creation, can't put in multiple hard prompts at the same time. 
# solution: in function calls, say a function for recording expense, put another model with the required hard prompt in it.